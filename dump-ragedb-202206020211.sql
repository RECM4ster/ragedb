...
--
-- Host: 127.0.0.1    Database: ragedb
-- ------------------------------------------------------
...
CREATE TABLE `ban` (
  ...
  `ban_user_id` int(11) DEFAULT NULL,
  `ban_admin` int(11) DEFAULT NULL,
  `ban_reason` text,
  `ban_time_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ban_time_end` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ban_is_active` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`ban_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `post` VALUES (1,'asad','asdasd',4,NULL,NULL,NULL,NULL),(2,'asad','asdasd',4,NULL,NULL,NULL,NULL),(3,'asad','asdasd',4,NULL,NULL,NULL,NULL),(4,'asad','asdasd',4,NULL,NULL,NULL,NULL),(5,'asad','asdasd',4,NULL,NULL,NULL,NULL),(6,'duuupa','xaxaxa',4,NULL,NULL,NULL,1653519988),(7,'testPost','xaxaxaxa',4,NULL,NULL,NULL,1653780164),(8,'Testowy postr','Wyswietli sie\r\nÄ™?\r\ndcsac',4,NULL,NULL,NULL,1654114191);
...
INSERT INTO `reaction` VALUES (8,4,4,0),(9,2,4,0);
...
CREATE TABLE `sex` (
  ...
  `sex_primary` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`sex_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_pronoun`
--

DROP TABLE IF EXISTS `user_pronoun`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_pronoun` (
  `up_id` int(11) NOT NULL AUTO_INCREMENT,
  `up_us_id` int(11) DEFAULT NULL,
  `up_pro_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`up_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_pronoun`
--

LOCK TABLES `user_pronoun` WRITE;
/*!40000 ALTER TABLE `user_pronoun` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_pronoun` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-02  2:12:00
